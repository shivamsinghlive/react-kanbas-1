...
export default function PathParameters() {
    ...
    return (
        <div>
            ...
            <input type="number" className="form-control mb-2" id="wd-path-parameter-a" defaultValue={a}
                    onChange={(e) => setA(e.target.value)}/>
            <input type="number" className="form-control mb-2" id="wd-path-parameter-b" defaultValue={b}
